function [clustCent,data2cluster,cluster2dataCell] = meanShiftCentroidsGaussian(dataPts,centroids,bandWidth, plotOn)
...
weight_map = exp(-(0 : 255^2) / hr^2);  % map of the colors weights
